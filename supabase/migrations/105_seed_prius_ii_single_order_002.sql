-- Un nuovo ordine Reliefbattery da un pezzo per Toyota Prius II 2004-2009.
do $$
declare
  v_client_id uuid;
...
begin
  ...
  insert into public.shopify_orders (
    ...
    v_client_id, 'wms-manual-prius-ii-20260904-002.aimago.local',
    'RLB-PRIUS-II-20260904-002', '#RLB-PRIUS-II-002',
  ...
  insert into public.shopify_order_items (
    ...
    v_order_id, 'RLB-PRIUS-II-20260904-002-1', v_reference.id,
