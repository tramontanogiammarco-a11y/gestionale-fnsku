...
import { ArrowLeft, Barcode, CheckCircle2, ChevronRight, Layers3, Loader2, MapPin, Play, ScanLine, ShoppingBag, Trash2 } from "lucide-react";
...
function GalluseQueue() {
  ...
  return <div className="wms-page pb-24" data-testid="wms-galluse-queue">
    ...
    <section className="grid grid-cols-3 gap-2">
      ...
      <Metric label="Bag richieste" value={round?.numero_ordini || 0} />
    </section>
    ...
    <section>
      ...
      {round ? <article className="rounded-md border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <p className="mt-4 rounded-md bg-slate-50 px-3 py-2 text-xs text-slate-600">All'avvio si apre lo scanner. Inquadra il carrello che stai usando e il sistema carichera automaticamente le bag configurate nelle sue posizioni.</p>
