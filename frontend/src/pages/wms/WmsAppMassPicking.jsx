...
function MassMission({ batchId }) {
  ...
  return <div className="space-y-5 pb-24" data-testid="wms-mass-picking-mission">
    ...
    <CameraScanner open={cameraOpen} onOpenChange={setCameraOpen} purpose={bagConfirmation ? "universal" : "location"} context={scannerContext} onDetected={(value) => { setCameraOpen(false); if (bagConfirmation) confirmBag(value); else scanSlot(value); }} />
  </div>;
}
