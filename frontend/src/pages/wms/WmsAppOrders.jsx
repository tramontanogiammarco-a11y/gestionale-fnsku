  ...
  return (
    <button type="button" onClick={onClick} className="w-full rounded-md border border-slate-200 bg-white p-4 text-left shadow-sm hover:border-teal-300">
      <div className="flex items-start gap-3">
        ...
        <span className="min-w-0 flex-1"><span className="flex flex-wrap items-center gap-2"><strong className="text-lg">{order.order_name}</strong>{order.wave === "arretrati" && <span className="rounded-md bg-amber-50 px-2 py-1 text-[10px] font-black uppercase text-amber-800">Arretrato</span>}</span><span className="mt-1 block text-xs text-slate-500">{order.cliente_ragione_sociale}</span></span>
